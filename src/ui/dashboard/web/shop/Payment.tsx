            ...
            <form ref={formRef} id="pay-form">
                ...
                <div className="row w-100">
                    <div className="input col">
                        ...
                        <input type="email" name="email" id="email" placeholder="Email" onChange={(e) => onEmailTextChange && onEmailTextChange(e.target.value)} required={true} />
                    </div>

                    <div className="input col">
                        <label htmlFor="email">Phone</label>
                        <input type="text" name="phone" id="phone" placeholder="Phone" onChange={(e) => onPhoneTextChange && onPhoneTextChange(e.target.value)} required={true} />
                    </div>

                    <div className="input col">
                        <div className="payment row" style={{padding: 0}}>
                            <span className="mr-2 span-first" style={{background: "#fff", padding: 0}}>
                                <input type="text" style={{background: "#fff"}} placeholder={price.toString()} />
                            </span>
